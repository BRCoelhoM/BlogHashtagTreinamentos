...
from flask_login import login_user, logout_user, logout_user, current_user, login_required
import secrets
import os
...
@login_required
def usuarios():
    lista_usuarios = lista_usuarios = Usuario.query.all()
...
def login():
    ...
    if form_login.validate_on_submit() and 'botao_submit_login' in request.form:
        ...
        if usuario and bcrypt.check_password_hash(usuario.senha,form_login.senha.data):
            login_user(usuario, remember=form_login.lembra_dados.data)
...
def salvar_imagem(imagem):
    ...
    # Adicionar um código aleatório ao nome da imagem
...
def editar_perfil():
    ...
    if form.validate_on_submit():
        ...
        # Mudar o campo foto do perfil do usuario para o novo nome da imagem
...
@app.route('/perfil/<post_id>/excluir', methods=['GET','POST'])
@login_required
